...
$query = "SELECT o.*, c.make AS offered_make, c.model AS offered_model, c.year AS offered_year, c.mileage AS offered_mileage, c.price AS offered_price, c.description AS offered_description, c.image AS offered_image, o.user_id
          FROM trades o
